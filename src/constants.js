...
export default {
    ...
    DEMO_TYPE_AHEAD_OPTIONS: [
        ...
        {key: 'What Inventory is associated with VRF:dmz and type:epg', url: 'http://172.31.219.91:5000/what?model=demo&tile_type=N_INVENTORY&associated_to=ctx-dmz and type:N_EPG'},
        ...
        {key: 'Can VRF:dmz talk to VRF:secured', url: 'http://172.31.219.91:5000/which?model=demo&from=ctx-dmz&to=ctx-secured&filter=&pivot=&through='},
